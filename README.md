...
`v0.3.3` improves Forkscape's GitHub presentation and discoverability:

- Added a real product screenshot near the top of the README.
- Added a Chinese audience section to make the use case easier to understand.
- Prepared the repository for clearer GitHub discovery through project topics.
