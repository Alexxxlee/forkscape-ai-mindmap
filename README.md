...
- 支持 Markdown、PNG、SVG、Mermaid 导出，用于笔记、分享和文档整理。

## 最新更新

`v0.4.1` 补齐了更多文档导出能力：

- 新增 Mermaid 导出，方便放进 Markdown 文档和技术笔记。
- 文档同步更新 Mermaid 导出说明。
...
- Markdown, PNG, SVG, and Mermaid export for notes, sharing, and documentation.

## Latest Update

`v0.4.1` completes another documentation export path:

- Added Mermaid export for Markdown documents and technical notes.
- Updated project documentation to include Mermaid export.
